        ...
        <div className='w-full h-128'>
            <div className='flex flex-col h-full'>
                <div className="bg-hof-dark-blue mx-1 mb-2 h-full">
                    <div className="border-hof-gold border-x-4 flex flex-col justify-between items-center w-full h-2/3">
                      <Image src={crownLarge} alt="Logo" className="h-12 w-12 mt-1" />
                      <span className='text-6xl text-hof-green font-bebas'>HOF</span>
                      <span className='text-lg text-hof-gold font-alfa'>OR</span>
                      <span className='text-6xl text-hof-red font-bebas'>NOT</span>
                      <div className='text-xl py-2 px-4 w-full text-center bg-hof-gold text-hof-dark-blue font-alfa'>THE PEOPLE&apos;S VOTE FOR THE HALL OF FAME</div>
                    </div>
